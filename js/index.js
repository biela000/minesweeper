...
class MineSweeper {
    ...
    winGame() {
        ...
        const tookTime = currTime - this.startTime;
        const minutes = Math.floor(Math.floor(tookTime / 1000.0) / 60.0);
        const seconds = Math.floor(tookTime / 1000.0) - 60 * minutes;
        const millis = tookTime - minutes * 60000 - seconds * 1000;
        CookieHandler.post({
            id: Date.now(),
            mode: `${this.width}x${this.height}_M${this.mineCount}`,
